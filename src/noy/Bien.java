...
public abstract class Bien implements  Comparable<Bien>, Serializable {
    ...
    public Bien(String adresse, Wilaya wilaya, float surface, Proprietaire proprietaire, TypeDeTransaction transaction, float prix, boolean negociable, String descriptif, LocalDate date, String photos)  {
    ...
    public void modifierdate(LocalDate date){
        this.date=date;
    }
