...
public abstract class Habitable extends Bien {
    ...
    public Habitable(String adresse, Wilaya wilaya, float surface, Proprietaire proprietaire, TypeDeTransaction transaction, float prix, boolean negociable, String descriptif, LocalDate date, String photos, int nbr_pieces, Boolean meuble) {
