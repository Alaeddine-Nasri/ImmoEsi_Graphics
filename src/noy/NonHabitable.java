...
public abstract class NonHabitable extends Bien implements Serializable {
    private int nbr_facades;
    private String etat_juridique;

    public NonHabitable(String adresse, Wilaya wilaya, float surface, Proprietaire proprietaire, TypeDeTransaction transaction, float prix, boolean negociable, String descriptif, LocalDate date, String photos, int nbr_facades, String etat_juridique) {
